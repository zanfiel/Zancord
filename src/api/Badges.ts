...
import globalBadges from "@zancordplugins/globalBadges";
...
export function _getBadges(args: BadgeUserArgs) {
    ...
    const ZancordDonorBadges = BadgeAPIPlugin.getZancordDonorBadges(args.userId);
    ...
    if (ZancordDonorBadges) {
        badges.unshift(
            ...ZancordDonorBadges.map(badge => ({
                ...args,
                ...badge,
            }))
        );
