...
import { shouldShowContributorBadge, shouldShowZancordContributorBadge } from "@utils/misc";
...
const ZancordContributorBadge: ProfileBadge = {
    description: "Zancord Contributor",
    iconSrc: Zancord_CONTRIBUTOR_BADGE,
    position: BadgePosition.START,
    shouldShow: ({ userId }) => shouldShowZancordContributorBadge(userId),
    onClick: (_, { userId }) => openContributorModal(UserStore.getUser(userId)),
    props: {
        style: {
            borderRadius: "50%",
...
let ZancordDonorBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
export default definePlugin({
    ...
    get ZancordDonorBadges() {
        return ZancordDonorBadges;
    },
    ...
    userProfileBadges: [ContributorBadge, ZancordContributorBadge, UserPluginContributorBadge],
    ...
    getZancordDonorBadges(userId: string) {
        return ZancordDonorBadges[userId]?.map(badge => ({
            iconSrc: badge.badge,
            description: badge.tooltip,
            position: BadgePosition.START,
            props: {
