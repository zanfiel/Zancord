...
console.log("[Zancord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Zancord");
    ...
    console.log("[Zancord] Running in vanilla mode. Not loading Zancord");
}

console.log("[Zancord] Loading original Discord app.asar");
