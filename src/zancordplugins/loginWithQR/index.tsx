...
export default definePlugin({
    ...
    start() {
        SettingsPlugin.customEntries.push({
            key: "Zancord_login_with_qr",
            title: getIntlMessage("USER_SETTINGS_SCAN_QR_CODE"),
            Component: openQrModal,
            Icon: QrCodeIcon
        });
        SettingsPlugin.settingsSectionMap.push(["ZancordLoginWithQR", "Zancord_login_with_qr"]);
        preload();
    },

    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "Zancord_login_with_qr");
        removeFromArray(SettingsPlugin.settingsSectionMap, entry => entry[1] === "Zancord_login_with_qr");
        unload();
    },
});
