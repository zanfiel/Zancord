...
export default definePlugin({
    ...
    authors: [ZancordDevs.ZcraftElite, ZancordDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average Zancord extension,
