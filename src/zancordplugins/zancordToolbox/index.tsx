        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Zancord Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("zancordToolbox", "VencordToolbox");
export default definePlugin({
    name: "zancordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Zancord quick actions",
