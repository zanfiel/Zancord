...
import { toggleEnabled } from "@zancordplugins/zancordHelper/utils";
...
const BUILT_IN_CATEGORIES: CommandCategory[] = [
    {
        ...
        label: "Quick Actions",
        description: "Common Zancord shortcuts"
    },
    {
        id: "plugins",
        label: "Plugins",
        description: "Manage Zancord and Vencord plugins"
    },
    {
    ...
    },
    {
        id: "updates",
        label: "Updates",
        description: "Stay up to date with Zancord"
    },
    {
        id: "discord-settings",
...
const BUILT_IN_COMMANDS: CommandEntry[] = [
    {
        id: "open-Zancord-settings",
        label: "Open Zancord Settings",
        keywords: ["settings", "Zancord"],
        categoryId: DEFAULT_CATEGORY_ID,
        tags: [TAG_NAVIGATION, TAG_CORE],
        handler: () => SettingsRouter.openUserSettings("Zancord_main_panel")
    },
    {
        ...
        handler: () => SettingsRouter.openUserSettings("Zancord_plugins_panel")
    },
    {
        id: "reload-windows",
...
function registerUpdateCommands() {
    registerCommand({
        ...
        description: "Checks for Zancord updates",
    ...
    registerCommand({
        ...
        description: "Opens the Zancord changelog",
        keywords: ["updates", "changelog"],
        categoryId: "updates",
        tags: [TAG_DEVELOPER, TAG_NAVIGATION],
        handler: () => SettingsRouter.openUserSettings("Zancord_changelog_panel")
    });
}
...
function registerCustomizationCommands() {
    ...
    registerCommand({
        ...
        handler: () => SettingsRouter.openUserSettings("Zancord_themes_panel")
    });
}
