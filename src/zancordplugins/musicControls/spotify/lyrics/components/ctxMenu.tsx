...
import { providers } from "@zancordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@zancordplugins/musicControls/spotify/lyrics/providers/store";
