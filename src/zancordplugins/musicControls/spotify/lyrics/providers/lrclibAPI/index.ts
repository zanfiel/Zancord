...
import { LyricsData, Provider } from "@zancordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@zancordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Zancord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
