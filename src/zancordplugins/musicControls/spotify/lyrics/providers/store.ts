...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@zancordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@zancordplugins/musicControls/spotify/SpotifyStore";
