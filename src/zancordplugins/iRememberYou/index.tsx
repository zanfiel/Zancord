...
export default definePlugin({
    ...
    authors: [ZancordDevs.zoodogood, ZancordDevs.keircn],
    ...
    async start() {
        SettingsPlugin.customEntries.push({
            key: "Zancord_i_remember_you",
            title: "I Remember You",
            Component: () => <DataUI usersCollection={data.usersCollection} />,
            Icon: EyeIcon
        });
        SettingsPlugin.settingsSectionMap.push(["ZancordIRememberYou", "Zancord_i_remember_you"]);
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "Zancord_i_remember_you");
        removeFromArray(SettingsPlugin.settingsSectionMap, entry => entry[1] === "Zancord_i_remember_you");
