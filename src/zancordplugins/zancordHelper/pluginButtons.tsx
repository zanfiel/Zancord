...
import { isZancordGuild, isZancordSupport } from "@utils/misc";
...
export const PluginButtons = ErrorBoundary.wrap(function PluginCards({ message }: { message: Message; }) {
    ...
    const shouldAddPluginButtons = pluginData && isZancord && (startsWithEnabled || startsWithDisabled);
            ...
            <Button
                ...
                onClick={async () => {
                    try {
                        ...
                        new Logger("zancordHelper").error("Error while toggling:", e);
