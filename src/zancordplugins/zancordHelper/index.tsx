...
import { Devs, ZancordDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
export default definePlugin({
    ...
    authors: [Devs.thororen, ZancordDevs.nyx, ZancordDevs.Naibuu, ZancordDevs.keircn, ZancordDevs.SerStars, ZancordDevs.mart, ZancordDevs.omaw],
    required: true,
    settings,
    headerBarButton: {
        icon: ShieldIcon,
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by Zancord!",
                    confirmText: "Zancord Support",
                    onConfirm() {
