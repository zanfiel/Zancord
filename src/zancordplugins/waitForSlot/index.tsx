...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/Zancord/Zancord-Assets/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [ZancordDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
