                            ...
                            <UserSummaryItem
                                ...
                                renderUser={(user: User) => (
                                    <Clickable
                                        ...
                                        onClick={() => isZancordPlugin ? openContributorModal(user) : openContributorModal(user)}
                                    >
                                        <img
                    ...
                    <Flex style={{ justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        {!pluginMeta.userPlugin && (
                            <div className={cl("links")}>
                                <WebsiteButton
                                    text="Website"
                                    href={isZancordPlugin ? `https://github.com/zanfiel/Zancord/tree/main/src/zancordplugins/${plugin.name}` : `https://vencord.dev/plugins/${plugin.name}`}
                                />
                                <GithubButton
                                    text="Source Code"
