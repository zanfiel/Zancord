...
const SHIGGY_DONATE_IMAGE = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Ccircle cx='12' cy='12' r='12' fill='%2300FF41'/%3E%3Ctext x='12' y='16.5' text-anchor='middle' fill='white' font-size='14' font-weight='bold' font-family='sans-serif'%3EZ%3C/text%3E%3C/svg%3E";
...
function ZancordSettings() {
    ...
    return (
        <SettingsTab>
            {(isZancordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    title="Donations"
                    subtitle="Thank you for donating!"
                    description={
                        isZancordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Zancord users can see your Zancord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Zancord donor badge, make a ticket in Zancord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Zancord users can see your badge! You can manage your perks by making a ticket in Zancord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Zancord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Zancord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Zancord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Zancord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
            </Paragraph>
...
export default wrapTab(ZancordSettings, "Zancord Settings");

export function isZancordDonor(userId: string): boolean {
    const donorBadges = BadgeAPI.getZancordDonorBadges(userId);
