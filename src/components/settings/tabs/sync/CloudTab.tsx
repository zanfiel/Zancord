    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                Zancord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Choose which cloud backend to use for storing your settings. You can switch between Zancord's and Vencord's cloud services, or use a self-hosted instance.
            </Paragraph>
            ...
            <SearchableSelect
                ...
                closeOnSelect={true}
                renderOptionPrefix={o => o?.value?.includes("Zancord") ? <ZancordIcon /> : <VencordIcon />}
            />
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your Zancord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
