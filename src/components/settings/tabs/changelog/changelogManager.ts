...
const CHANGELOG_HISTORY_KEY = "ZancordChangelog_History";
const LAST_SEEN_HASH_KEY = "ZancordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "ZancordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "ZancordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "ZancordChangelog_LastRepoCheck";
